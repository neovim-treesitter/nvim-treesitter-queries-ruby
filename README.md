...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-ruby/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-ruby/actions/workflows/validate.yml)

Neovim tree-sitter queries for **ruby**, part of the
...
- [ ] Changes are scoped to `ruby` — do not include files for other languages
